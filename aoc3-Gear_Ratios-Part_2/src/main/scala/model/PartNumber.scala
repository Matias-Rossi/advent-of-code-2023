...
/*
  private def hasEngineSymbolInRange(rowBefore: RowData, rowBeingProcessed: RowData, rowAfter: RowData): Boolean = {
    rowAfter.symbols.exists(symbol => SymbolIsInPartRange(this, symbol)) ||
      rowBeingProcessed.symbols.exists(symbol => SymbolIsInPartRange(this, symbol)) ||
      rowBefore.symbols.exists(symbol => SymbolIsInPartRange(this, symbol))
  }
